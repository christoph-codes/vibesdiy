  ...
  return (
    <>
      <Head>
        ...
        <meta content="brand.primary.default" name="msapplication-TileColor" />
        <link href="/favicon@3x.png" rel="apple-touch-icon" sizes="180x180" />
        <link
          href="/favicon@2x.png"
          rel="icon"
          sizes="32x32"
      ...
      <main className={`${styles.PageTemplate} ${className}`}>{children}</main>
      <Footer />
      <PoweredBy />
    </>
  );
