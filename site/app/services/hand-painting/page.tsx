...
const HandPainting = () => {
  return (
    ...
    >
      ...
      <Section>
        ...
        >
          ...
          >
            ...
            <Text>
              Choose your favorite pop culture item and bring out your inner
              child. Choose your paint, get your brushes, and enjoy as you paint
          ...
          >
            ...
            <Text>
              With over 50+ different figurines from purses, sneakers, cartoon
              characters, and baseball hats the possibilities are endless.
            </Text>
          </Box>
        </Flex>
      ...
      <Section containerClass={styles.HandPainting__gallery} paddingTop={0}>
