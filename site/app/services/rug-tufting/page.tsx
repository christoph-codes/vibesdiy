      ...
      <Section>
        ...
        >
          ...
          >
            ...
            <Text>
              With an easy to follow tutorial by your instructor, you will have
              the ability to choose your yarn and start creating your rug.
            </Text>
          </Box>
          <Box
            textAlign="center"
          ...
          >
            ...
            <Text>
              With over 90+ different colors of yarn, if you can think it, trace
              it, you can make it. Here is to a one of a kind rug to show off to
              your followers, houseguests and friends.
            </Text>
          </Box>
        </Flex>
      ...
      <Section containerClass={styles.RugTufting__gallery} paddingTop={0}>
        <Flex flexDir="column" alignItems="center">
          <Flex
            ...
            marginBottom={8}
          >
            <Image src="/tufting2.jpg" alt="Rug Tufting is amazing" />
            <Image src="/tufting3.jpg" alt="Rug Tufting is amazing" />
            <Image src="/tufting4.jpg" alt="Rug Tufting is amazing" />
          </Flex>
