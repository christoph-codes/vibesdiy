...
const PaintPouring = () => {
  return (
    ...
    >
      ...
      <Section>
        ...
        >
          ...
          >
            ...
            <Text>
              We supply you with endless colors to make your figurine one of a
              kind. Squirt your paint into your cup, don’t mix, and pour it’s
              that easy.
            </Text>
          </Box>
          <Box
          ...
          >
            ...
            <Text>
              No two paint pour projects look the same and that’s the beauty of
              this session. With endless color options to choose from whether
              you want a marble finish, paint splatter, or a trippy effect, pick
              your favorite 3 colors and let this relaxing, fun experience bring
      ...
      <Section containerClass={styles.PaintPouring__gallery} paddingTop={0}>
        <Flex flexDir="column" alignItems="center">
          ...
          >
            ...
            />
            <Image src="/services2.jpg" alt="Paint Pouring is amazing" />
            <Image src="/pour1.jpg" alt="Paint Pouring is amazing" />
          </Flex>
