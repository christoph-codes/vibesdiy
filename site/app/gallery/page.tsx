    ...
    >
      ...
      <Section>
        ...
        <Text textAlign="center">
          View our amazing collection of photos that showcase the amazing works
          of art created by us and our customers!
        </Text>
      </Section>
      <Section paddingTop={0}>
        ...
        >
          ...
          <Link href="http://prettydone.com/" target="_blank">
            <Box as="strong" _hover={{ color: "brand.primary.default" }}>
              Pretty Done
            </Box>
          </Link>
        </Text>
