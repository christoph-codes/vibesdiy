    ...
    <PageTemplate className={styles.Home}>
      ...
      >
        <Text
          ...
          color="white"
        >
          From start to finish immerse yourself into this creative space for
      ...
      >
        ...
        <Text fontSize="xl" marginBottom={4}>
          ...
          <br />
          <Link className="LINK" href="https://goo.gl/maps/Lr47ZATSsNbsaMXf6">
        ...
        >
          ...
          <Box width="100%">
            ...
            >
              ...
              <Text>
                Also we offer paint pouring or hand painting with all the colors
                you can think of over 20+ figures of popular fashion and cartoon
                art pieces that makes for a relaxing experience you’ll want to
